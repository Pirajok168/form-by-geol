...
ALTER TABLE litho_card_entity
    ADD CONSTRAINT uc_litho_card_entity_litho_card UNIQUE (litho_card);

ALTER TABLE borehole
    ADD CONSTRAINT FK_BOREHOLE_ON_CALCULATION_RESULTS FOREIGN KEY (calculation_results_id) REFERENCES calculation_results (id);

ALTER TABLE borehole
    ADD CONSTRAINT FK_BOREHOLE_ON_COMPLETED_ACT FOREIGN KEY (completed_act_id) REFERENCES completed_act (id);

ALTER TABLE borehole
    ADD CONSTRAINT FK_BOREHOLE_ON_CONTROL_TABLE FOREIGN KEY (control_table_id) REFERENCES control_table (id);

ALTER TABLE borehole
    ADD CONSTRAINT FK_BOREHOLE_ON_DRILLING_LINE FOREIGN KEY (drilling_line_id) REFERENCES drilling_line (id);

ALTER TABLE borehole
    ADD CONSTRAINT FK_BOREHOLE_ON_NUGGETS_CHARACTERISTICS FOREIGN KEY (nuggets_characteristics_id) REFERENCES nuggets_characteristics (id);

ALTER TABLE borehole
    ADD CONSTRAINT FK_BOREHOLE_ON_SHUTDOWN_ACT FOREIGN KEY (shutdown_act_id) REFERENCES shutdown_act (id);

ALTER TABLE borehole
    ADD CONSTRAINT FK_BOREHOLE_ON_SUMMARY FOREIGN KEY (summary_id) REFERENCES summary (id);

ALTER TABLE lithological_section
    ADD CONSTRAINT FK_LITHOLOGICAL_SECTION_ON_BOREHOLE FOREIGN KEY (borehole_id) REFERENCES borehole (id);

ALTER TABLE lithological_section_lithoCardEntities
    ADD CONSTRAINT fk_litseclit_on_litho_card_entity FOREIGN KEY (lithoCardEntities_id) REFERENCES litho_card_entity (id);

ALTER TABLE lithological_section_lithoCardEntities
    ADD CONSTRAINT fk_litseclit_on_lithological_section FOREIGN KEY (lithologicalSection_id) REFERENCES lithological_section (id);